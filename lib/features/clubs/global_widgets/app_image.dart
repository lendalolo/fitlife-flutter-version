...
import '../common/constant/constant_remote.dart';
...
class AppImage extends StatelessWidget {
  ...
  const AppImage.network(
    ...
    this.colorFilter,
    this.size,
  }) : _source = Source.network , package = null;
      ...
      switch (_source) {
        ...
        case Source.network:
          return SvgPicture.network(
            "${ConstantVariables.baseUrlForFile}/$path",
      ...
      switch (_source) {
        ...
        case Source.network:
          return CachedNetworkImage(
            imageUrl: "${ConstantVariables.baseUrlForFile}/$path",
            color: color,
